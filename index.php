...
<!-- 
<div class="main-post">
    <h3 class="post-title">This Is Our Main Post Title 1</h3>
    <span class="post-author"><i class="fa fa-user fa-fw"></i> Ahmed, </span>
    <span class="post-date"><i class="fa fa-calendar fa-fw"></i> 20/5/2021, </span>
    <span class="post-comments"><i class="fa fa-comments-o fa-fw"></i> 20 Comments, </span>
    <img class="img-fluid img-thumbnail" src="https://dummyimage.com/600x200/944c12/fff" alt="" />
